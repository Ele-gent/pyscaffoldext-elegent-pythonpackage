...
Welcome to `pyscaffoldext-elegent-pythonpackage` contributor's guide.
...
If you experience bugs or general issues with `pyscaffoldext-elegent-pythonpackage`, please have a look
...
You can help improve `pyscaffoldext-elegent-pythonpackage` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`pyscaffoldext-elegent-pythonpackage` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `pyscaffoldext-elegent-pythonpackage`'s files. While this mechanism can
...
```
conda create -n pyscaffoldext-elegent-pythonpackage python=3 six virtualenv pytest pytest-cov
conda activate pyscaffoldext-elegent-pythonpackage
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/pyscaffoldext-elegent-pythonpackage.git
...
5. Install [pre-commit]:
   ...
   `pyscaffoldext-elegent-pythonpackage` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/pyscaffoldext-elegent-pythonpackage
[issue tracker]: https://github.com/<USERNAME>/pyscaffoldext-elegent-pythonpackage/issues
